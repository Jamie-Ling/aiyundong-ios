...
@interface MBHUBAutoPop : NSObject
 ...
 */
#define HIDDENMBProgressHUD [MBHUBAutoPop hiddenMBProgressHUD];
+(void) hiddenMBProgressHUD;

+(MBProgressHUD *) MBProgressHUD;

#define SHOWMBProgressHUD(aTitle, aMsg, aImg, aDimBG, aDelay) [MBHUBAutoPop showMBProgressHUDTitle:aTitle msg:aMsg image:aImg dimBG:aDimBG delay:aDelay];
+(MBProgressHUD *) showMBProgressHUDTitle:(NSString *)aTitle msg:(NSString *)aMsg image:(UIImage *)aImg dimBG:(BOOL)dimBG delay:(float)d;

#define SHOWMBProgressHUDIndeterminate(aTitle, aMsg, aDimBG) [MBHUBAutoPop showMBProgressHUDModeIndeterminateTitle:aTitle msg:aMsg dimBG:aDimBG];
