                     ...
                     andYearNumber: (NSInteger ) yearNumber
{
    ...
    if (self) {
        ...
        _showDate = [NSString stringWithFormat:@"%ld/%ld%@", (long)yearNumber, (long)weekNumber, LS_Text(@"Week")];
    }
    return self;
}
...
- (NSString *)showDate
{
    return [NSString stringWithFormat:@"%ld/%ld%@", _yearNumber, _weekNumber, LS_Text(@"Week")];
}
